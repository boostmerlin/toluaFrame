Shader "Custom/UI Particle Addtive"
{
	Properties
	{
		...
		//[HideInInspector]
		_ColorMultiply("_ColorMultiply", float) = 2
		...
		SubShader
		{
			...
			CGPROGRAM
				...
				{
					half4 color = _ColorMultiply * (tex2D(_MainTex, IN.texcoord) + _TextureSampleAdd) * IN.color;
