...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule(null);
		AppDefWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		LuaProfilerWrap.Register(L);
		ManagerWrap.Register(L);
		L.BeginModule("LuaFramework");
		LuaFramework_CSUtilWrap.Register(L);
		LuaFramework_LuaHelperWrap.Register(L);
		LuaFramework_ResourceManagerWrap.Register(L);
		LuaFramework_LuaBehaviourWrap.Register(L);
		LuaFramework_MyGameUtilWrap.Register(L);
		L.EndModule();
		L.BeginModule("Lean");
		L.BeginModule("Touch");
		Lean_Touch_LeanTouchWrap.Register(L);
		Lean_Touch_LeanFingerWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("DG");
		...
		L.RegFunction("Action_Lean_Touch_LeanFinger", System_Action_Lean_Touch_LeanFinger);
		L.RegFunction("Action_System_Collections_Generic_List_Lean_Touch_LeanFinger", System_Action_System_Collections_Generic_List_Lean_Touch_LeanFinger);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_Lean_Touch_LeanFinger(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<Lean.Touch.LeanFinger>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<Lean.Touch.LeanFinger>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_System_Collections_Generic_List_Lean_Touch_LeanFinger(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<System.Collections.Generic.List<Lean.Touch.LeanFinger>>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<System.Collections.Generic.List<Lean.Touch.LeanFinger>>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
