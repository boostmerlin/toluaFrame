...
namespace SG
{
    public class ObjectPoolManager : MonoBehaviour
    {
        ...
        private static ObjectPoolManager mInstance = null;
        ...
        public static ObjectPoolManager Instance
        {
            get
            {
                if (mInstance == null)
                {
                    GameObject go = new GameObject("ResourceManager", typeof(ObjectPoolManager));
                    ...
                    mInstance = go.GetComponent<ObjectPoolManager>();
